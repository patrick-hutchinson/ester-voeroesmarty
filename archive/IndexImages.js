...
export default function IndexImages({ projects, page }) {
  ...
  useEffect(() => {
    ...
    projects.forEach((practice, i) => {
      ...
      let target = page === "slug" ? practice.attributes : practice.attributes.cover.data.attributes;
      ...
      if (practice.attributes.cover.data.attributes.formats) {
        ...
        practice.attributes.cover.data.attributes.url.includes(".mp4", "mov", "avi", "flv", "wmv", "3gp", "mkv", "webm")
      ) {
        ////////////////////////////////////
        // VIDEO
        ////////////////////////////////////
  ...
  return (
    <div className="practice-images-threejs">
      <div
        ref={mountRef}
        className="threejs"
        style={{ width: "100vw", height: "100vh", position: "fixed", top: 0, pointerEvents: "none", zIndex: 2 }}
      ></div>
      <div
